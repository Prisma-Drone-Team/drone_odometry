...
def generate_launch_description():
    ...
    parameters=[{'frame_id':'zed_camera_link',
                 ...
                 'initial_pose' :'0.2 0.0 -0.07 0.0 0.0 0.0'}]
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={  'camera_model': 'zedm',
                                ...
                                'camera_name': 'zed' }.items()
        ),
        launch_ros.actions.Node(
            package = "tf2_ros",
            executable = "static_transform_publisher",
            name = "base_link_to_zed_camera_link",
            arguments=["0.2", "0.0", "-0.07", "0", "0", "0", "base_link", "zed_camera_link"]
        ),
        # launch_ros.actions.Node(
        #     package = "tf2_ros",
        #     executable = "static_transform_publisher",
        #     name = "odom_to_zed_odom",
        #     arguments=["0.2", "0.0", "-0.07", "0", "0", "0", "odom", "zed_odom"]
        # ),
        ...
        # launch_ros.actions.Node(   
        #     package='rtabmap_sync', executable='rgbd_sync', output='screen',
        #     parameters=[{'frame_id':'zed_front_camera_link',
        #                  'subscribe_rgbd':True,
        #                  'approx_sync':False,
        #                  'wait_imu_to_init':True}],
        ...
        #     package='rtabmap_slam', executable='rtabmap', output='screen',
        #     parameters=[{'frame_id':'zed_front_camera_link',
        #                  'odom_frame_id': 'zed_front_odom',
        #                  'publish_tf':True,
        #                  'subscribe_rgbd':True,
        #                  'approx_sync':False,
        #                  'wait_imu_to_init':True}],
        #     remappings=[('imu', '/zed_front/zed_node/imu/data'),
        #                 ('odom', '/zed_front/zed_node/odom')],
        #     arguments=['-d']),
        ...
        launch_ros.actions.Node(
            ...
            parameters=[
                {
                    'px4_odom_frame_id': "map",
                    'publish_tf': True,
                    'feed_twist_to_px4': True,
                    'odom_parent_is_not_map': True,
